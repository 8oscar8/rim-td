...
export class UIManager {
  ...
  showWorkTooltip(e, type) {
    ...
    const workData = {
        ...
        mining: { name: '채광 작업', desc: '강철을 주력으로 생산하며, 숙련도가 오르면 <span style="color:var(--accent-blue)">플라스틸(Plasteel)</span>, <span style="color:var(--accent-gold)">부품(Component)</span>, <span style="color:#00f2ff">우라늄(Uranium)</span>을 추가로 채굴할 수 있습니다. 둔기(Blunt) 강화와 기계식 무기 제작의 핵심입니다.' },
